...
const MENU_ITEMS = [
  ...
  { title: '커뮤니티', desc: '크리스천과 신앙을 나눠보세요', icon: '✝️', href: '/dashboard/community', ready: true },
  { title: '말씀 묵상', desc: '오늘의 말씀 묵상 기록', icon: '📖', href: '/dashboard/meditation', ready: true },
];
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-9 space-y-4">
            {/* 찬양 검색 카드 */}
            <div className="rounded-2xl bg-orange-100 p-8 dark:bg-orange-500/20">
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-xl border border-orange-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-orange-400 dark:border-orange-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                />
