        ...
        <div className="w-full max-w-sm">
            <div className="mb-8 text-center">
                <svg viewBox="0 0 100 100" className="mx-auto mb-4 w-30 h-30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="prismGradReg" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <path d="M50 15L85 75H15L50 15Z" stroke="url(#prismGradReg)" strokeWidth="2" fill="none" opacity="0.3" />
                    <path d="M50 15L65 75M50 15L35 75M50 15V75" stroke="url(#prismGradReg)" strokeWidth="1.5" strokeLinecap="round" />
                    <circle cx="50" cy="15" r="4" fill="#4F46E5" filter="url(#glowReg)" />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={inputCls}
                        />
                        <label className="mb-1 block text-sm font-medium text-gray-500 dark:text-gray-200">특수문자를 포함해주세요.</label>
                    </div>
